...
/**
 * Reads the pinned Hermes tag from packages/react-native/sdks/.hermesv1version.
 * The single 0.87 policy ignores RCT_HERMES_V1_ENABLED. The value is a git tag in
...
switch (command) {
  ...
  case 'resolve-commit': {
    ...
    if (tag == null) {
      echo('Could not read pinned Hermes tag from sdks/.hermesv1version');
      process.exit(1);
    }
