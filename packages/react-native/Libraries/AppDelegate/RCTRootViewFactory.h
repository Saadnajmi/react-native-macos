...
typedef RCTPlatformView *_Nonnull ( // [macOS]
...
typedef void (^RCTCustomizeRootViewBlock)(RCTPlatformView *rootView); // [macOS]
 ...
 */
- (RCTPlatformView *_Nonnull)viewWithModuleName:(NSString *)moduleName // [macOS]
